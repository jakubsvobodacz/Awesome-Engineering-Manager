...
* [Dedicated QA vs. Developer/Engineering Testing](https://blog.airbrake.io/blog/software-testing/dedicated-qa-vs-developer-engineering-testing) - should you have a dedicated QA engineers or should everyone be QA by default in order to properly test their changes
...
* [Marian's List](https://www.marianslist.com/) - Curated talent matchmaking for engineering and product leadership roles in Central Europe with verified candidate profiles
### People Development
...
* [Is “Request for Changes” an Essential Pull Request Insight — or Just a Misleading Metric?](https://medium.com/gitconnected/is-request-for-changes-an-essential-pull-request-insight-or-just-a-misleading-metric-da6311b9f3ac) - My article evaluates whether “request for changes” in pull requests is a reliable quality metric or a potentially misleading indicator for Engineering Managers. While it can flag issues, its value is limited without considering broader review contexts and individual team member's behavioral patterns in code reviews
* [Reviewing code you didn't write](https://coles.codes/posts/reviewing-code-you-didnt-write/) - Explains how to prioritize the issue that matters in a review, especially when AI produced the change
### Coding Practices
